...
const int draw_after_moves = 10;   // Definición de la constante draw_after_moves
const bool turn_board = false;     // Definición de la constante turn_board

float Bot::Evaluate(const Board& b)  // Cambiado a const Board&
{
	float white=0;
	float black=0;
